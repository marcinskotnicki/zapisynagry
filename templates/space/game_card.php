                ...
                <ul class="player-list sp-slots">
                    <?php $slot = 0; foreach ($crew as $p): $slot++; ?>
                        <li class="player sp-slot sp-slot-filled">
                            ...
                            <span class="sp-who"><?= e($p['name']) ?><?php if ($p['knows_rules'] !== null && $p['knows_rules'] !== ''): ?><?= rules_icon_html(rules_tone($p['knows_rules']), knows_rules_label($p['knows_rules'])) ?><?php endif; ?><?php if (is_admin() && !empty($p['user_id'])): ?><span class="p-acct" title="<?= e(t('player_account_bound', $p['account_name'] ?? ('#' . (int)$p['user_id']))) ?>">@</span><?php endif; ?></span>
                    ...
                    <ul class="player-list sp-slots sp-standby">
                        <?php $r = 0; foreach ($standby as $p): $r++; ?>
                            <li class="player player-reserve sp-slot sp-slot-filled">
                                ...
                                <span class="sp-who"><?= e($p['name']) ?><?php if ($p['knows_rules'] !== null && $p['knows_rules'] !== ''): ?><?= rules_icon_html(rules_tone($p['knows_rules']), knows_rules_label($p['knows_rules'])) ?><?php endif; ?></span>
                                <?php if (!$readonly && messaging_allowed() && !empty($p['email'])): ?>
                                    <a class="msg-icon" href="message.php?player=<?= (int)$p['id'] ?>" title="<?= e(t('msgbtn_player')) ?>" aria-label="<?= e(t('msgbtn_player')) ?>">&#9993;</a>
                                <?php endif; ?>
                                <?php if (!$readonly && verify_can_show_buttons($p['user_id'])): ?>
