<?php
/* =============================================================================
 *  templates/glass/poll_card.php — one poll, as a glass strip.
 * -----------------------------------------------------------------------------
                    ...
                    <?php if (!empty($poll['comments'])): ?>
                        <ul class="comment-list">
                            <?php foreach ($poll['comments'] as $c): ?>
                                <li><span class="c-name"><?= e($c['name']) ?>:</span> <?= nl2br(e($c['comment'])) ?><?= comment_edit_html($c, 'poll') ?><?= comment_delete_html($c, 'poll') ?></li>
                            <?php endforeach; ?>
                        </ul>
                    <?php endif; ?>
                    <?php if (!$readonly): ?>
