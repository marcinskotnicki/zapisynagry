...
<?php // Skipped entirely when the admin shows deleted games in full: the
      ...
      // by front_event.php. ?>
<?php if ((int)$g['is_archived'] === 1 && deleted_games_display() !== 'full'): // soft-deleted -> a decommissioned rig ?>
                ...
                <?php if ($p !== null): ?>
                    <div class="gc-slot sk-berth">
                        ...
                        <?php if (!$readonly && verify_can_show_buttons($p['user_id'])): ?>
                            <a class="gc-resign" href="delete_player.php?player=<?= (int)$p['id'] ?>" rel="nofollow"><?= e(t('delete')) ?></a>
                        <?php endif; ?>
                    </div>
