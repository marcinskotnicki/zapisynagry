<?php
/* =============================================================================
 *  templates/light/add_game_club_list.php — pick a game from the club's shelf.
 * -----------------------------------------------------------------------------
    ...
    <div class="field club-filter" hidden>
        ...
        <ul class="lib-list club-pick-list">
            <?php foreach ($games as $g): ?>
                <li class="lib-item">
                    <a class="club-pick" href="add_game.php?table=<?= (int)$table['id'] ?>&amp;club=<?= (int)$g['id'] ?>">
